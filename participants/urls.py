...
from participants.views import home ,Rsvp, register_participant , participant ,delete_participant, edit_participant ,event_details ,register_participant_for_admin
urlpatterns = [
