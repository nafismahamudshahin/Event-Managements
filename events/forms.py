...
class StyledFormMixin:
    input_classes = (
        "w-full px-4 py-3 rounded-lg bg-zinc-900 text-white border border-neutral-700 "
        "placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition-all"
    )
    ...
    checkbox_classes = (
        "form-checkbox h-5 w-5 text-rose-500 bg-zinc-800 border-neutral-700 rounded focus:ring-rose-500"
    )
