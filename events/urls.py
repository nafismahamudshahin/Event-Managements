...
from events.views import test, register_event,register_participant,register_category ,admin_dashboard ,editEventInfo ,deleteEvent ,category_management ,edit_category , delete_category
urlpatterns = [
    path('test/',test),
